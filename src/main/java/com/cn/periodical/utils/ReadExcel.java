...
//        }
    ...
    public List<AddressInfo> readXls() throws Exception {
        try {
//            InputStream is = new FileInputStream( this.filePath+ File.separator+this.fileName);
        ...
        // 循环工作表Sheet
            ...
            for(int rowNum = 1; rowNum <= hssfSheet.getLastRowNum(); rowNum++){
                ...
                if("".equals(addressInfo.getReceivePostcode()) && "".equals(addressInfo.getReceiveAddress()) && "".equals(addressInfo.getContacterName())
                        && "".equals(addressInfo.getContacterName()) && 0==addressInfo.getSubscribeNums()){
                      break ;
                }
