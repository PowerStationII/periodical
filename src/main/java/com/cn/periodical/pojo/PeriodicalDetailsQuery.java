...
/**
 * PeriodicalDetailsQuery
 * @author code-generator
 *
 */
public class PeriodicalDetailsQuery extends PagingQuery {
	private static final long serialVersionUID = 1L;
	
	public  PeriodicalDetailsQuery(){
		super(1, 10);
	}
	
	public  PeriodicalDetailsQuery(int pageNo, int pageSize){
