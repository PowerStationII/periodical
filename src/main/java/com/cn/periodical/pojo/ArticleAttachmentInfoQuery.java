...
/**
 * ArticleAttachmentInfoQuery
 * @author code-generator
 *
 */
public class ArticleAttachmentInfoQuery extends PagingQuery {
	private static final long serialVersionUID = 1L;
	
	public  ArticleAttachmentInfoQuery(){
		super(1, 10);
	}
	
	public  ArticleAttachmentInfoQuery(int pageNo, int pageSize){
