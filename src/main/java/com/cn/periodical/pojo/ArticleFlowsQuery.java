 ...
 *
 */
public class ArticleFlowsQuery extends PagingQuery {
	private static final long serialVersionUID = 1L;
	
	public  ArticleFlowsQuery(){
		super(1, 10);
	}
	...
	private java.util.Date dealStartTime;
	 ...
	 * @param dealStartTime
	 */
	public void setDealStartTime(java.util.Date dealStartTime) {
	 ...
	 * @return
	 */
	public java.util.Date getDealStartTime() {
