 ...
 *
 */
public class CouncilInfoQuery extends PagingQuery {
	private static final long serialVersionUID = 1L;
	
	public  CouncilInfoQuery(){
		super(1, 10);
	}
	
	public  CouncilInfoQuery(int pageNo, int pageSize){
